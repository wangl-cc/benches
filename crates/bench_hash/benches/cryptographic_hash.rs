...
fn main() -> std::process::ExitCode {
    harness::run_benchmark_from_env(
        "Run cryptographic hash benchmarks and write structured raw JSON",
        benchmark_group,
    )
}

fn benchmark_group() -> BenchmarkGroup {
    BenchmarkGroup::builder("Cryptographic Hash")
        ...
        .case(bench_hash::cases::Sha256)
        .case(bench_hash::cases::Sha512)
        .case(bench_hash::cases::Blake3)
        .case(bench_hash::cases::Blake2b512)
        .build()
}
